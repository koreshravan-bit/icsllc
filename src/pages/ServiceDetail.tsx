...
import { serviceDetails, ServiceId } from "@/data/services-content";
import { services } from "@/data/navigation";

const ServiceDetail = () => {
  const { serviceId } = useParams<{ serviceId: string }>();
  
  const service = serviceId ? serviceDetails[serviceId as ServiceId] : null;
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Let's discuss how our {service.name.toLowerCase()} can help transform your business.
            </p>
